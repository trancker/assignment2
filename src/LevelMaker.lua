...
function LevelMaker.createMap(level)
    ...
    local i = math.random(numRows)
    local j = math.random(numCols)
    if unbreakablebrick then
        ub = Brick(
            -- x-coordinate
            (j-1)                
            * 32                  
        ...
        ub.unbreakablebrick = true
        ub.cantbreak = true
        ub.color = 6
        ub.tier = 1
    end
    table.insert(bricks, ub)
